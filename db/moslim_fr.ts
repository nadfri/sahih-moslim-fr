...
export const moslim_fr: HadithType[] = [
...

  {
    ...
    chapter: "Introduction",
    narrator: "Abou Huraira",
    matn: "Il y aura, à la fin de ma communauté, des gens qui vous raconteront des choses que ni vous ni vos pères n'avez entendues, alors méfiez-vous d'eux.",
    sahabas: [],
    isnad: "",
    arabic:
  ...
  /*La Foi*/
  {
    ...
    matn: "La première personne qui a parlé sur le destin à Bassora est **Ma'bad Al Jouhani**. Alors que j'étais parti avec **Houmayd Ibn 'Abder Rahman Al Houmayri** pour le Hajj ou la 'Omra nous avons dit : Si nous rencontrons un des compagnons du Prophète (qu'Allah les agrée tous), nous le questionnerons sur ce que disent ceux-là sur le destin. Nous avons donc trouvé 'Abdallah Ibn 'Omar (qu'Allah les agrée lui et son père) dans la mosquée et j'ai dit : Ô Abou 'Abder Rahman ! Il est apparu des gens derrière nous qui lisent le Coran, étudient la science et font telle et telle chose. Ces gens disent qu'il n'y a pas de destin et que les choses se produisent par elles-mêmes. **Abdallah ibn Omar** (qu'Allah les agrée lui et son père) a dit : « Lorsque tu rencontreras ces gens, informe-les que je me désavoue d'eux et qu'ils se désavouent de moi. Je jure par la divinité de **Abdallah ibn Omar** ! Si l'un d'eux possédait l'équivalent de la montagne de Ouhoud en or qu'il dépenserait dans le bien, Allah ne l'aurait pas accepté de lui jusqu'à ce qu'il croit au destin ».",
    arabic:
      "عن يحيى بن معمر قال: كان أول من قال في القدر بالبصرة معبد الجهني، فانطلقت أنا وحميد بن عبد الرحمن الحميري حاجين أو معتمرين، فقلنا: لو لقينا أحدًا من أصحاب رسول الله ﷺ فسألناه عما يقول هؤلاء في القدر، فوفق لنا عبد الله بن عمر بن الخطاب رضي الله عنهما داخلًا المسجد، فقلت: أبا عبد الرحمن! إنه قد ظهر قبلنا ناس يقرؤون القرآن ويتقفرون العلم، وذكر من شأنهم، وأنهم يزعمون أن لا قدر، وأن الأمر أنف. قال عبد الله بن عمر رضي الله عنهما: فإذا لقيت أولئك فأخبرهم أني بريء منهم وأنهم برآء مني، والذي يحلف به عبد الله بن عمر، لو أن لأحدهم مثل أحد ذهبًا فأنفقه ما قبله الله منه حتى يؤمن بالقدر.",
  },
...

  {
    ...
    sahabas: [],
    matn: "Un homme est venu au Prophète ﷺ et a dit : \n\nMontre moi une oeuvre que je pourrais pratiquer et qui me rapprocherait du paradis et m’éloignerait du feu.\n\n\nLe Prophète ﷺ a dit : « Tu adores Allah et tu ne Lui associes rien, tu accomplies la prière, tu t’acquittes de la zakat et tu lies tes liens de parenté ».\n\n\nQuand l’homme est parti le Prophète ﷺ a dit : « S’il s’accroche à ce qui lui a été ordonné il rentrera dans le paradis ».",
    isnad: "",
    arabic:
      "عن أبي أيوب الأنصاري رضي الله عنه قال : جاء رجل إلى النبي صلى الله عليه وسلم فقال : دلني على عمل أعمله يدنيني من الجنة ويباعدني من النار قال النبي صلى الله عليه وسلم : تعبد الله لا تشرك به شيئا وتقيم الصلاة وتؤتي الزكاة وتصل رحمك فلما أدبر قال النبي صلى الله عليه وسلم : إن تمسك بما أمر به دخل الجنة",
  },

  {
    ...
    matn: "**Nu‘mān ibn Qawqal** vint trouver le Prophète ﷺ et dit : \n« Si j’accomplis les prières obligatoires, que je m’éloigne de ce qui est interdit, et que je considère licite ce qu’Allah a rendu licite, entrerai-je au Paradis ? » \n\nLe Prophète ﷺ répondit par l’affirmative.\"",
    isnad: "",
    arabic: "حَدَّثَنَا أَبُو بَكْرِ بْنُ أَبِي شَيْبَةَ، وَأَبُو كُرَيْبٍ - وَاللَّفْظُ لأَبِي كُرَيْبٍ - قَالاَ حَدَّثَنَا أَبُو مُعَاوِيَةَ، عَنِ الأَعْمَشِ، عَنْ أَبِي سُفْيَانَ، عَنْ جَابِرٍ، قَالَ أَتَى النَّبِيَّ صلى الله عليه وسلم النُّعْمَانُ بْنُ قَوْقَلٍ فَقَالَ يَا رَسُولَ اللَّهِ أَرَأَيْتَ إِذَا صَلَّيْتُ الْمَكْتُوبَةَ وَحَرَّمْتُ الْحَرَامَ وَأَحْلَلْتُ الْحَلاَلَ أَأَدْخُلُ الْجَنَّةَ فَقَالَ النَّبِيُّ صلى الله عليه وسلم ‏ \"‏ نَعَمْ ‏\"‏ ‏.‏\n",
  },

  {
    ...
    sahabas: [],
    matn: "Le Prophète ﷺ a dit: \n\n« L’Islam est bâti sur cinq choses: sur le fait d’unifier Allah, d’accomplir la prière, de s’acquitter de la zakat, de jeûner le Ramadan et de faire le pèlerinage ».",
    isnad: "",
    arabic:
      "عن عبدالله بن عمر رضي الله عنهما قال النّبي صلّى الله عليه و سلّم : بُنِيَ الإسلامُ على خمسةٍ : على أن يُوَحَّدَ اللهُ وإقامِ الصلاةِ وإيتاءِ الزكاةِ وصيامِ رمضانَ والحجِّ",
  },
    ...
    matn: "Le Prophète ﷺ a dit à **Al-Ashajj** de la tribu de ‘Abd al-Qays : \n\n« Tu possèdes deux qualités qu’Allah aime : la douceur et la patience. »",
    isnad: "",
    arabic: "عن عبدالله بن عباس رضي الله عنهما قال النبي صلى الله عليه و سلم للأشج عبد القيس رضي الله عنه : إن فيك خصلتين يحبهما الله : الحلم والأناة",
  },
...

  {
    ...
    narrator: "Abou Huraira",
    sahabas: [],
    matn: "Le Messager d’Allah ﷺ a dit :\n\n« Il m’a été ordonné de combattre les gens jusqu’à ce qu’ils témoignent qu’il n’y a de divinité qu’Allah. Celui qui professe cela voit sa vie et ses biens protégés de ma part, sauf pour ce qui est dû en droit. Quant à son jugement final, il appartient à Allah. »",
    isnad: "",
    arabic:
...

  {
    ...
    sahabas: [],
    matn: "Le Prophète ﷺ a dit:\n\n« Celui qui unifie Allah et mécroit dans ce qui est adoré en dehors d’Allah alors son argent et son sang sont interdits et son jugement incombe à Allah ».",
    isnad: "",
    arabic:
      "عن طارق بن أشيم رضي الله عنه قال النّبي صلّى الله عليه و سلّم : مَنْ قَالَ لاَ إِلَهَ إِلاَّ اللَّهُ وَكَفَرَ بِمَا يُعْبَدُ مِنْ دُونِ اللَّهِ حَرُمَ مَالُهُ وَدَمُهُ وَحِسَابُهُ عَلَى اللَّهِ",
  },
...

  {
    ...
    sahabas: [],
    matn: "Le Messager d’Allah ﷺ a dit :\n\n« Celui qui meurt sachant (de manière complète) qu’il n’y a de dieu qu’Allah, il entrera au Paradis. »",
    isnad: "",
    arabic: "حَدَّثَنَا أَبُو بَكْرِ بْنُ أَبِي شَيْبَةَ، وَزُهَيْرُ بْنُ حَرْبٍ، كِلاَهُمَا عَنْ إِسْمَاعِيلَ بْنِ إِبْرَاهِيمَ، - قَالَ أَبُو بَكْرٍ حَدَّثَنَا ابْنُ عُلَيَّةَ، - عَنْ خَالِدٍ، قَالَ حَدَّثَنِي الْوَلِيدُ بْنُ مُسْلِمٍ، عَنْ حُمْرَانَ، عَنْ عُثْمَانَ، قَالَ قَالَ رَسُولُ اللَّهِ صلى الله عليه وسلم ‏ \"‏ مَنْ مَاتَ وَهُوَ يَعْلَمُ أَنَّهُ لاَ إِلَهَ إِلاَّ اللَّهُ دَخَلَ الْجَنَّةَ ‏\"‏ ‏.‏",
  },
