...
export const moslim_fr: HadithType[] = [
  ...
  /*La Foi*/
  {
    ...
    sahabas: ["Ma'bad Al Jouhani", "Houmayd ibn Abder Rahman Al Houmayri", "Abdallah ibn Omar"],
