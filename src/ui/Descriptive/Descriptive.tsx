  ...
  return (
    <div className="max-w-3xl mx-auto my-8 p-6 rounded-lg bg-white/90 dark:bg-gray-800/90 shadow-md">
      ...
      <p className="mb-3 text-gray-700 dark:text-gray-300">
        ...
        dans la tradition musulmane, juste après le <em>Sahih al-Bukhari</em>.
        Elle est une référence majeure pour l'étude de la Sunna et du droit
        islamique.
      </p>
      <p className="text-gray-700 dark:text-gray-300">
        <span className="text-emerald-700 dark:text-emerald-400 font-bold">
          L'Imam Moslim ibn al-Hajjaj
        </span>{" "}
        (821-875), originaire de Nishapur (actuel Iran), était un érudit réputé
        pour son intégrité et sa méthodologie stricte dans la collecte des
        hadiths. Son travail a profondément marqué la science du hadith.
      </p>
    </div>
  );
}
