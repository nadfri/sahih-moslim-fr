...
vi.mock("./ExportSection/ExportSection", () => ({
  ExportSection: () => <div data-testid="export-section">Export Section</div>,
}));

vi.mock("./ImportSection/ImportSection", () => ({
...
vi.mock("./ImportConfirmModal/ImportConfirmModal", () => ({
...
vi.mock("./FailedItemsModal/FailedItemsModal", () => ({
