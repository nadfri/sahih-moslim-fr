...
import { FailedItemsModal } from "./FailedItemsModal/FailedItemsModal";
...
export function DataManagement({ datas }: { datas: DatasType }) {
  ...
  return (
    <>
      <div className="bg-linear-to-br from-white to-emerald-50/30 dark:from-gray-800 dark:to-emerald-950/20 rounded-xl shadow-lg border border-emerald-100 dark:border-emerald-900/50 overflow-hidden">
        <button
